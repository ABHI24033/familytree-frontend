...
import EventRSVPForm from "../../components/event/EventRSVPForm"; // [RESTORED]
                ...
                <div className="card border-0 rounded-4 mb-5 bg-transparent">
                    ...
                    <div className="row g-4 mt-2">
                        ...
                        <div className="col-lg-4">
                            ...
                            {/* Add External Guest Form (Host Only) */}
                            {/* {isHost && (
                                <>
                                    {!showAddExternalGuest ? (
                                        <button
                                            className="btn btn-outline-primary w-100 mb-3 fw-bold border-2 border-dashed p-3 rounded-4"
                                            onClick={() => setShowAddExternalGuest(true)}
                                        >
                                            <Icon icon="mdi:plus-circle-outline" className="fs-4 me-2" />
                                            Add Friend / Relative
                                        </button>
                                    ) : (
                                        <div className="mb-4 position-relative">
                                            <button
                                                className="btn btn-sm btn-light position-absolute top-0 end-0 m-2 z-1"
                                                onClick={() => setShowAddExternalGuest(false)}
                                            >
                                                <Icon icon="mdi:close" />
                                            </button>
                                            <AddExternalGuestForm eventId={event._id} onClose={() => setShowAddExternalGuest(false)} />
                                        </div>
                                    )}
                                </>
                            )} */}
