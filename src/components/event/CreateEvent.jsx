                        ...
                        <div className="card-body p-2 p-lg-5">
                                        ...
                                        <div className="col-lg-6">
                                            <div className="mb-4">
                                                ...
                                                <div className="card border-0 bg-light rounded-4 p-3 mb-3">
                                                    ...
                                                    <div className="row g-2">
                                                        <div className="col-7"><input type="date" className="form-control" value={startDate} onChange={(e) => setStartDate(e.target.value)} /></div>
                                                        <div className="col-5"><input type="time" className="form-control" value={startTime} onChange={(e) => setStartTime(e.target.value)} /></div>
                                                    </div>
                                                </div>
                                                <div className="card border-0 bg-light rounded-4 p-3">
                                                    <p className="small text-muted mb-2 fw-semibold">End Date & Time</p>
                                                    <div className="row g-2">
                                                        <div className="col-7"><input type="date" className="form-control" value={endDate} onChange={(e) => setEndDate(e.target.value)} /></div>
                                                        <div className="col-5"><input type="time" className="form-control" value={endTime} onChange={(e) => setEndTime(e.target.value)} /></div>
                                                    </div>
                                                </div>
                                            </div>
                            ...
                            {currentStep === 2 && (
                                <div className="p-5 animation-fade-in">
                                    ...
                                    {/* Tabs */}
                                    <ul className="nav nav-tabs border-bottom-0 mb-3 flex-nowrap  hide-scrollbar" role="tablist">
                                        ...
                                        <div className="card-body p-0">
                                            ...
                                            <div className="p-2 p-md-5 hide-scrollbar" style={{ maxHeight: "400px" }}>
                                                <div className="row g-2 p-10 g-md-3">
                                                    {(activeTab === 'family' ? allGuests : allExternalContacts).map((guest) => {
                                                        ...
                                                        return (
                                                            <div className="col-12 col-md-4" key={guest.id}>
                                                                <div className={`card border-0 rounded-4 p-2 p-md-3 transition-all cursor-pointer ${isSelected ? 'shadow-sm bg-primary bg-opacity-10 border border-primary border-opacity-25' : 'bg-light bg-opacity-50 hover-bg-light border border-transparent'}`}
                                                                    onClick={() => toggleGuest(guest, activeTab === 'friends')}>
                                                                    <div className="d-flex align-items-center gap-2 px-10 py-4">
                                                                        <div className="form-check m-0">
                                                                            <input className="form-check-input" type="checkbox" readOnly
                                                                                checked={isSelected} style={{ width: '20px', height: '20px' }} />
                                                                        </div>
                                                                        <div className="flex-shrink-0">
                                                                            {guest.avatar ? (
                                                                                <img src={guest.avatar} className="rounded-circle shadow-sm border border-2 border-white" width="44" height="44" alt={guest.name} />
                                                                            ) : (
                                                                                <div className="rounded-circle bg-primary-focus shadow-sm d-flex align-items-center justify-content-center text-primary fw-bold border border-2 border-white" style={{ width: "44px", height: "44px" }}>
                                                                                    {guest.name.charAt(0)}
                                                                                </div>
                                                                            )}
                                                                        </div>
                                                                        <div className="overflow-hidden">
                                                                            <h6 className={`mb-0 fw-bold text-sm text-truncate ${isSelected ? 'text-primary' : ''}`}>{guest.name}</h6>
                                                                            <p className="smaller text-muted mb-0">{guest.phone || guest.email || guest.relation}</p>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                            </div>
                                    ...
                                    {/* Invite Format Controls */}
                                    <div className="mt-4 row g-2 g-md-3">
                                        <div className="col-12 col-md-6">
                                            <div className={`card border-0 rounded-4 p-3 h-100 transition-all ${sendWhatsAppToFamily ? 'bg-primary bg-opacity-10 border border-primary border-opacity-10 shadow-sm' : 'bg-light bg-opacity-50 border border-transparent'}`}>
                                                <div className="d-flex align-items-center justify-content-between mb-2">
                                                    <div className="d-flex align-items-center gap-2">
                                                        <div className={`p-6 d-flex align-items-center justify-content-center rounded-3 ${sendWhatsAppToFamily ? 'bg-primary text-white' : 'bg-white text-muted shadow-sm'}`}>
                                                            <Icon icon="mdi:whatsapp" width={20} />
                                                        </div>
                                                        <label className="fw-bold mb-0">Invite Family</label>
                                                    </div>
                                                    <div className="d-flex gap-3">
                                                        <div className="form-check d-flex align-items-center gap-2">
                                                            <input className="form-check-input" type="radio" name="swFamily" id="swFamilyYes" checked={sendWhatsAppToFamily} onChange={() => setSendWhatsAppToFamily(true)} />
                                                            <label className="form-check-label small fw-bold" htmlFor="swFamilyYes">Yes</label>
                                                        </div>
                                                        <div className="form-check d-flex align-items-center gap-2">
                                                            <input className="form-check-input" type="radio" name="swFamily" id="swFamilyNo" checked={!sendWhatsAppToFamily} onChange={() => setSendWhatsAppToFamily(false)} />
                                                            <label className="form-check-label small fw-bold" htmlFor="swFamilyNo">No</label>
                                                        </div>
                                                    </div>
                                                </div>
                                                {sendWhatsAppToFamily && (
                                                    <div className="mt-2 pt-2 border-top border-primary border-opacity-10 animate-fade-in">
                                                        <div className="form-check d-flex align-items-center gap-2 custom-checkbox">
                                                            <input className="form-check-input" type="checkbox" checked={inviteWithFamily} onChange={e => setInviteWithFamily(e.target.checked)} id="iwFamily" />
                                                            <label className="form-check-label smaller text-muted fw-medium" htmlFor="iwFamily">Include all family members in one invite</label>
                                                        </div>
                                                    </div>
                                                )}
                                            </div>
                                        ...
                                        <div className="col-12 col-md-6">
                                            <div className={`card border-0 rounded-4 p-3 h-100 transition-all ${sendWhatsAppToFriends ? 'bg-primary bg-opacity-10 border border-primary border-opacity-10 shadow-sm' : 'bg-light bg-opacity-50 border border-transparent'}`}>
                                                <div className="d-flex align-items-center justify-content-between mb-2">
                                                    <div className="d-flex align-items-center gap-2">
                                                        <div className={`p-6 d-flex align-items-center justify-content-center rounded-3 ${sendWhatsAppToFriends ? 'bg-primary text-white' : 'bg-white text-muted shadow-sm'}`} style={{ width: '40px', height: '40px' }}>
                                                            <Icon icon="mdi:whatsapp" width={20} />
                                                        </div>
                                                        <label className="fw-bold mb-0">Invite Friends</label>
                                                    </div>
                                                    <div className="d-flex gap-3">
                                                        <div className="form-check d-flex align-items-center gap-2">
                                                            <input className="form-check-input" type="radio" name="swFriends" id="swFriendsYes" checked={sendWhatsAppToFriends} onChange={() => setSendWhatsAppToFriends(true)} />
                                                            <label className="form-check-label small fw-bold" htmlFor="swFriendsYes">Yes</label>
                                                        </div>
                                                        <div className="form-check d-flex align-items-center gap-2">
                                                            <input className="form-check-input" type="radio" name="swFriends" id="swFriendsNo" checked={!sendWhatsAppToFriends} onChange={() => setSendWhatsAppToFriends(false)} />
                                                            <label className="form-check-label small fw-bold" htmlFor="swFriendsNo">No</label>
                                                        </div>
                                                    </div>
                                                </div>
                                                {sendWhatsAppToFriends && (
                                                    <div className="mt-2 pt-2 border-top border-primary border-opacity-10 animate-fade-in">
                                                        <div className="form-check d-flex align-items-center gap-2 custom-checkbox">
                                                            <input className="form-check-input" type="checkbox" checked={friendsInviteWithFamily} onChange={e => setFriendsInviteWithFamily(e.target.checked)} id="ifFriends" />
                                                            <label className="form-check-label smaller text-muted fw-medium" htmlFor="ifFriends">Include all family members in one invite</label>
                                                        </div>
                                                    </div>
                                                )}
                                            </div>
                                    ...
                                    <div className="mt-5 d-flex flex-column flex-md-row justify-content-between gap-3">
                                        ...
                                        <div className="d-flex flex-column flex-md-row gap-2 order-1 order-md-2">
                                            ...
                                            <button className="btn btn-primary px-5 py-3 fw-bold rounded-3 shadow-sm d-flex align-items-center justify-content-center" onClick={handleCreateEvent} disabled={createEventMutation.isPending}>
